...
# ---------------------------------------------------------------------------
var achievements := [
	{"id": "kill_narwhal", "group": "kill", "name": "ユニコーンキラー", "desc": "ユニコーン を20体討伐", "check": "mob", "target": "narwhal", "need": 20, "buff": {"reload": 0.9940}, "icon": "res://assets/images/pixel/mob_narwhal.png"},
	{"id": "kill_seahunter", "group": "kill", "name": "シーハンターキラー", "desc": "シーハンター を20体討伐", "check": "mob", "target": "seahunter", "need": 20, "buff": {"speed": 1.0069}, "icon": "res://assets/images/pixel/mob_seahunter.png"},
	{"id": "kill_ornithocheirus", "group": "kill", "name": "オルニケイトスキラー", "desc": "オルニケイトス を20体討伐", "check": "mob", "target": "ornithocheirus", "need": 20, "buff": {"ram": 1.0079}, "icon": "res://assets/images/pixel/mob_ornithocheirus.png"},
	{"id": "kill_wyrm", "group": "kill", "name": "ワイアームキラー", "desc": "ワイアーム を20体討伐", "check": "mob", "target": "wyrm", "need": 20, "buff": {"shot_dmg": 1.0088}, "icon": "res://assets/images/pixel/mob_wyrm.png"},
	{"id": "kill_wyvern", "group": "kill", "name": "ワイバーンキラー", "desc": "ワイバーン を20体討伐", "check": "mob", "target": "wyvern", "need": 20, "buff": {"shot_speed": 1.0098}, "icon": "res://assets/images/pixel/mob_wyvern.png"},
	{"id": "kill_kraken", "group": "kill", "name": "クラーケンキラー", "desc": "クラーケン を20体討伐", "check": "mob", "target": "kraken", "need": 20, "buff": {"flag_dmg_taken": 0.9893}, "icon": "res://assets/images/pixel/mob_kraken.png"},
	{"id": "kill_starfish", "group": "kill", "name": "オニヒトデキラー", "desc": "オニヒトデ を20体討伐", "check": "mob", "target": "starfish", "need": 20, "buff": {"fleet_dmg_taken": 0.9883}, "icon": "res://assets/images/pixel/mob_starfish.png"},
	{"id": "kill_zaratan", "group": "kill", "name": "ザラタンキラー", "desc": "ザラタン を20体討伐", "check": "mob", "target": "zaratan", "need": 20, "buff": {"reload": 0.9874}, "icon": "res://assets/images/pixel/mob_zaratan.png"},
	{"id": "kill_mermaid", "group": "kill", "name": "マーメイドキラー", "desc": "マーメイド を20体討伐", "check": "mob", "target": "mermaid", "need": 20, "buff": {"speed": 1.0136}, "icon": "res://assets/images/pixel/mob_mermaid.png"},
	{"id": "kill_lamia", "group": "kill", "name": "ラミアキラー", "desc": "ラミア を20体討伐", "check": "mob", "target": "lamia", "need": 20, "buff": {"ram": 1.0145}, "icon": "res://assets/images/pixel/mob_lamia.png"},
	{"id": "kill_zombie_fish", "group": "kill", "name": "ゾンビウオキラー", "desc": "ゾンビウオ を60体討伐", "check": "mob", "target": "zombie_fish", "need": 60, "buff": {"shot_dmg": 1.0155}, "icon": "res://assets/images/pixel/mob_zombie_fish.png"},
	{"id": "kill_moon_jelly", "group": "kill", "name": "ムーンジェリーキラー", "desc": "ムーンジェリー を20体討伐", "check": "mob", "target": "moon_jelly", "need": 20, "buff": {"shot_speed": 1.0164}, "icon": "res://assets/images/pixel/mob_moon_jelly.png"},
	{"id": "kill_killer_shell", "group": "kill", "name": "キラーシェルキラー", "desc": "キラーシェル を20体討伐", "check": "mob", "target": "killer_shell", "need": 20, "buff": {"flag_dmg_taken": 0.9826}, "icon": "res://assets/images/pixel/mob_killer_shell.png"},
	{"id": "kill_carabos", "group": "kill", "name": "カーラボスキラー", "desc": "カーラボス を20体討伐", "check": "mob", "target": "carabos", "need": 20, "buff": {"fleet_dmg_taken": 0.9817}, "icon": "res://assets/images/pixel/mob_carabos.png"},
	...
	{"id": "kill_charybdis", "group": "kill", "name": "カリュブディスキラー", "desc": "カリュブディス を20体討伐", "check": "mob", "target": "charybdis", "need": 20, "buff": {"speed": 1.0202}, "icon": "res://assets/images/pixel/mob_charybdis.png"},
	{"id": "kill_amphiptere", "group": "kill", "name": "アンフィプテレキラー", "desc": "アンフィプテレ を20体討伐", "check": "mob", "target": "amphiptere", "need": 20, "buff": {"ram": 1.0212}, "icon": "res://assets/images/pixel/mob_amphiptere.png"},
	{"id": "kill_dagon", "group": "kill", "name": "ダゴンキラー", "desc": "ダゴン を20体討伐", "check": "mob", "target": "dagon", "need": 20, "buff": {"shot_dmg": 1.0221}, "icon": "res://assets/images/pixel/mob_dagon.png"},
	{"id": "kill_zahhak", "group": "kill", "name": "ザッハークキラー", "desc": "ザッハーク を20体討伐", "check": "mob", "target": "zahhak", "need": 20, "buff": {"shot_speed": 1.0231}, "icon": "res://assets/images/pixel/mob_zahhak.png"},
	{"id": "kill_tiamat", "group": "kill", "name": "ティアマットキラー", "desc": "ティアマット を20体討伐", "check": "mob", "target": "tiamat", "need": 20, "buff": {"flag_dmg_taken": 0.9760}, "icon": "res://assets/images/pixel/mob_tiamat.png"},
