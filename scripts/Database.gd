...
var lords := {
	...
	"night_bat_small":  {"name": "夜の帝王(小)",      "hp": 420,  "dmg": 16, "cap": 2,  "price": 500,  "bounty": 0, "fame": 0, "island": 6, "ranged": false, "aerial": true, "pair": false, "speed": 18.0, "size_mult": 0.4, "eye_glow": Vector2(0.20, 0.18), "eye_glow_fb": Vector2(0.0, -0.24), "is_split": true, "no_cargo": true, "lore": "夜の帝王が分裂した小型のコウモリ。すべて倒さないと討伐にならない。"},
