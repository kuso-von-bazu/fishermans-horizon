...
var combat_mobs := {
	...
	"zaratan":       {"name": "ザラタン",       "hp": 900, "dmg": 28, "cap": 6, "price": 720, "ranged": false, "aerial": false, "speed": 11.0, "atk_cd": 1.40, "reach": 3.0, "wave_melee": true, "face_left": true, "death_shot": {"count": 1, "mode": "aim", "dmg_mult": 0.7}, "color": Color(0.55,0.35,0.25)},
	...
	"mermaid":       {"name": "マーメイド",     "hp": 584, "dmg": 18, "cap": 4, "price": 600, "ranged": true,  "aerial": false, "speed": 12.0, "atk_cd": 1.1, "kite": true, "size_mult": 0.7, "scatter_aim": true, "scatter": 9, "scatter_speeds": [0.55, 0.95], "small_shot": true, "way": 0, "shot_dmg_mult": 0.30, "shot_speed_mult": 0.8, "face_left": true, "color": Color(0.35,0.7,0.75)},
	"lamia":         {"name": "ラミア",         "hp": 633, "dmg": 21, "cap": 4, "price": 620, "ranged": true,  "aerial": false, "speed": 11.5, "atk_cd": 0.8, "size_mult": 0.72, "way_choices": [2,3,4,5], "aim_tight": true, "needle_shot": true, "shot_dmg_mult": 0.55, "face_left": true, "color": Color(0.55,0.35,0.65)},
	...
	"moon_jelly":    {"name": "ムーンジェリー", "hp": 828, "dmg": 24, "cap": 5, "price": 660, "ranged": false, "aerial": false, "speed": 8.0,  "reach": 2.6, "entangle": true, "poison": true, "side_only": true, "color": Color(0.7,0.75,0.95)},
	...
	"carabos":       {"name": "カーラボス",     "hp": 1150, "dmg": 29, "cap": 6, "price": 900, "ranged": true,  "aerial": false, "speed": 12.0, "atk_cd": 1.2, "reach": 2.2, "shoot_moving": true, "way_choices": [1,2], "face_left": true, "color": Color(0.75,0.35,0.3)},
...
var lords := {
	...
	# #290再: ジェミニの横向き絵(pixel/lord_gemini.png)は実際には右向きに描かれているため face_left は false が正しい
	"gemini":    {"name": "ジェミニ",                 "hp": 6000, "hp_exact": 24000, "dmg": 38, "cap": 10, "price": 6000, "bounty": 28000, "fame": 34, "island": 10, "ranged": true, "aerial": true, "pair": true, "speed": 11.0, "atk_cd": 0.9, "radial": true, "radial_count": 20, "way": 0, "small_shot": true, "shot_dmg_mult": 0.32, "shot_speed_mult": 0.75, "aim_color": Color(0.95,0.92,0.35), "counter_shot": 1.0, "no_melee": true, "size_mult": 0.65, "spawn_dist_mult": 1.3, "dir": 30, "face_left": false, "color": Color(0.72,0.72,0.78), "lore": "堕天した双子の天使。"},
...
#   flag_dmg_taken/fleet_dmg_taken)。
#   #265再16: 全実績のバフを2倍に引き上げ。0.4〜3.0% だった効果は 0.8〜6.0% になっている
#   (fame_max/ultimate_player の一部ステータスは陣形の最小値5%を上回る)。
...
# ---------------------------------------------------------------------------
var achievements := [
	{"id": "kill_narwhal", "group": "kill", "name": "ユニコーンキラー", "desc": "ユニコーン を20体討伐", "check": "mob", "target": "narwhal", "need": 20, "buff": {"reload": 0.9880}, "icon": "res://assets/images/pixel/mob_narwhal.png"},
	{"id": "kill_seahunter", "group": "kill", "name": "シーハンターキラー", "desc": "シーハンター を20体討伐", "check": "mob", "target": "seahunter", "need": 20, "buff": {"speed": 1.0138}, "icon": "res://assets/images/pixel/mob_seahunter.png"},
	{"id": "kill_ornithocheirus", "group": "kill", "name": "オルニケイトスキラー", "desc": "オルニケイトス を20体討伐", "check": "mob", "target": "ornithocheirus", "need": 20, "buff": {"ram": 1.0158}, "icon": "res://assets/images/pixel/mob_ornithocheirus.png"},
	{"id": "kill_wyrm", "group": "kill", "name": "ワイアームキラー", "desc": "ワイアーム を20体討伐", "check": "mob", "target": "wyrm", "need": 20, "buff": {"shot_dmg": 1.0176}, "icon": "res://assets/images/pixel/mob_wyrm.png"},
	{"id": "kill_wyvern", "group": "kill", "name": "ワイバーンキラー", "desc": "ワイバーン を20体討伐", "check": "mob", "target": "wyvern", "need": 20, "buff": {"shot_speed": 1.0196}, "icon": "res://assets/images/pixel/mob_wyvern.png"},
	{"id": "kill_kraken", "group": "kill", "name": "クラーケンキラー", "desc": "クラーケン を20体討伐", "check": "mob", "target": "kraken", "need": 20, "buff": {"flag_dmg_taken": 0.9786}, "icon": "res://assets/images/pixel/mob_kraken.png"},
	{"id": "kill_starfish", "group": "kill", "name": "オニヒトデキラー", "desc": "オニヒトデ を20体討伐", "check": "mob", "target": "starfish", "need": 20, "buff": {"fleet_dmg_taken": 0.9766}, "icon": "res://assets/images/pixel/mob_starfish.png"},
	{"id": "kill_zaratan", "group": "kill", "name": "ザラタンキラー", "desc": "ザラタン を20体討伐", "check": "mob", "target": "zaratan", "need": 20, "buff": {"reload": 0.9748}, "icon": "res://assets/images/pixel/mob_zaratan.png"},
	{"id": "kill_mermaid", "group": "kill", "name": "マーメイドキラー", "desc": "マーメイド を20体討伐", "check": "mob", "target": "mermaid", "need": 20, "buff": {"speed": 1.0272}, "icon": "res://assets/images/pixel/mob_mermaid.png"},
	{"id": "kill_lamia", "group": "kill", "name": "ラミアキラー", "desc": "ラミア を20体討伐", "check": "mob", "target": "lamia", "need": 20, "buff": {"ram": 1.0290}, "icon": "res://assets/images/pixel/mob_lamia.png"},
	{"id": "kill_zombie_fish", "group": "kill", "name": "ゾンビウオキラー", "desc": "ゾンビウオ を60体討伐", "check": "mob", "target": "zombie_fish", "need": 60, "buff": {"shot_dmg": 1.0310}, "icon": "res://assets/images/pixel/mob_zombie_fish.png"},
	{"id": "kill_moon_jelly", "group": "kill", "name": "ムーンジェリーキラー", "desc": "ムーンジェリー を20体討伐", "check": "mob", "target": "moon_jelly", "need": 20, "buff": {"shot_speed": 1.0328}, "icon": "res://assets/images/pixel/mob_moon_jelly.png"},
	{"id": "kill_killer_shell", "group": "kill", "name": "キラーシェルキラー", "desc": "キラーシェル を20体討伐", "check": "mob", "target": "killer_shell", "need": 20, "buff": {"flag_dmg_taken": 0.9652}, "icon": "res://assets/images/pixel/mob_killer_shell.png"},
	{"id": "kill_carabos", "group": "kill", "name": "カーラボスキラー", "desc": "カーラボス を20体討伐", "check": "mob", "target": "carabos", "need": 20, "buff": {"fleet_dmg_taken": 0.9634}, "icon": "res://assets/images/pixel/mob_carabos.png"},
	{"id": "kill_merman", "group": "kill", "name": "マーマンキラー", "desc": "マーマン を90体討伐", "check": "mob", "target": "merman", "need": 90, "buff": {"reload": 0.9614}, "icon": "res://assets/images/pixel/mob_merman.png"},
	{"id": "kill_charybdis", "group": "kill", "name": "カリュブディスキラー", "desc": "カリュブディス を20体討伐", "check": "mob", "target": "charybdis", "need": 20, "buff": {"speed": 1.0404}, "icon": "res://assets/images/pixel/mob_charybdis.png"},
	{"id": "kill_amphiptere", "group": "kill", "name": "アンフィプテレキラー", "desc": "アンフィプテレ を20体討伐", "check": "mob", "target": "amphiptere", "need": 20, "buff": {"ram": 1.0424}, "icon": "res://assets/images/pixel/mob_amphiptere.png"},
	{"id": "kill_dagon", "group": "kill", "name": "ダゴンキラー", "desc": "ダゴン を20体討伐", "check": "mob", "target": "dagon", "need": 20, "buff": {"shot_dmg": 1.0442}, "icon": "res://assets/images/pixel/mob_dagon.png"},
	{"id": "kill_zahhak", "group": "kill", "name": "ザッハークキラー", "desc": "ザッハーク を20体討伐", "check": "mob", "target": "zahhak", "need": 20, "buff": {"shot_speed": 1.0462}, "icon": "res://assets/images/pixel/mob_zahhak.png"},
	{"id": "kill_tiamat", "group": "kill", "name": "ティアマットキラー", "desc": "ティアマット を20体討伐", "check": "mob", "target": "tiamat", "need": 20, "buff": {"flag_dmg_taken": 0.9520}, "icon": "res://assets/images/pixel/mob_tiamat.png"},
	{"id": "bounty_hunter", "group": "kill", "name": "バウンティハンター", "desc": "海賊を100隻、海賊王を2隻討伐", "check": "pirate_all", "target": "", "need": 100, "buff": {"shot_dmg": 1.0160}, "icon": "res://assets/images/pixel/pirate_king.png"},
	{"id": "lord_sawshark", "group": "lord", "name": "電動ノコギリザメ狩り", "desc": "電動ノコギリザメ を討伐", "check": "lord", "target": "sawshark", "need": 1, "buff": {"reload": 0.9920}, "icon": "res://assets/images/pixel/lord_sawshark.png"},
	{"id": "lord_dumbo", "group": "lord", "name": "ウミダンボ狩り", "desc": "ウミダンボ を討伐", "check": "lord", "target": "dumbo", "need": 1, "buff": {"speed": 1.0090}, "icon": "res://assets/images/pixel/lord_dumbo.png"},
	{"id": "lord_whale", "group": "lord", "name": "ヒゲマッコウナガスクジラ狩り", "desc": "ヒゲマッコウナガスクジラ を討伐", "check": "lord", "target": "whale", "need": 1, "buff": {"ram": 1.0102}, "icon": "res://assets/images/pixel/lord_whale.png"},
	{"id": "lord_walrus", "group": "lord", "name": "ギガントセイウチ狩り", "desc": "ギガントセイウチ を討伐", "check": "lord", "target": "walrus", "need": 1, "buff": {"shot_dmg": 1.0112}, "icon": "res://assets/images/pixel/lord_walrus.png"},
	{"id": "lord_aspidochelone", "group": "lord", "name": "アスピドケロン狩り", "desc": "アスピドケロン を討伐", "check": "lord", "target": "aspidochelone", "need": 1, "buff": {"shot_speed": 1.0122}, "icon": "res://assets/images/pixel/lord_aspidochelone.png"},
	{"id": "lord_legion", "group": "lord", "name": "レギオン狩り", "desc": "レギオン を討伐", "check": "lord", "target": "legion", "need": 1, "buff": {"flag_dmg_taken": 0.9866}, "icon": "res://assets/images/pixel/lord_legion.png"},
	{"id": "lord_undine", "group": "lord", "name": "ウンディーネ狩り", "desc": "ウンディーネ を討伐", "check": "lord", "target": "undine", "need": 1, "buff": {"fleet_dmg_taken": 0.9856}, "icon": "res://assets/images/pixel/lord_undine.png"},
	{"id": "lord_siren", "group": "lord", "name": "セイレーン狩り", "desc": "セイレーン を討伐", "check": "lord", "target": "siren", "need": 1, "buff": {"reload": 0.9846}, "icon": "res://assets/images/pixel/lord_siren.png"},
	{"id": "lord_night_emperor", "group": "lord", "name": "夜の帝王狩り", "desc": "夜の帝王 を討伐", "check": "lord", "target": "night_emperor", "need": 1, "buff": {"speed": 1.0166}, "icon": "res://assets/images/pixel/lord_night_emperor.png"},
	{"id": "lord_wraith", "group": "lord", "name": "レイス狩り", "desc": "レイス を討伐", "check": "lord", "target": "wraith", "need": 1, "buff": {"ram": 1.0176}, "icon": "res://assets/images/pixel/lord_wraith.png"},
	{"id": "lord_kraken_lord", "group": "lord", "name": "オクトパス狩り", "desc": "オクトパス を討伐", "check": "lord", "target": "kraken_lord", "need": 1, "buff": {"shot_dmg": 1.0186}, "icon": "res://assets/images/pixel/lord_kraken_lord.png"},
	{"id": "lord_griffon", "group": "lord", "name": "グリフォン狩り", "desc": "グリフォン を討伐", "check": "lord", "target": "griffon", "need": 1, "buff": {"shot_speed": 1.0198}, "icon": "res://assets/images/pixel/lord_griffon.png"},
	{"id": "lord_hydra", "group": "lord", "name": "ヒュドラ狩り", "desc": "ヒュドラ を討伐", "check": "lord", "target": "hydra", "need": 1, "buff": {"flag_dmg_taken": 0.9792}, "icon": "res://assets/images/pixel/lord_hydra.png"},
	{"id": "lord_quetzal", "group": "lord", "name": "ケツァルコアトル狩り", "desc": "ケツァルコアトル を討伐", "check": "lord", "target": "quetzal", "need": 1, "buff": {"fleet_dmg_taken": 0.9782}, "icon": "res://assets/images/pixel/lord_quetzal.png"},
	# #265再13: 雪夜の島の主。並びはケツァルコアトルと幽霊船の間。
	#   バフは既存の値を動かさず、その2つの間に収まる強さにしてある
	#   (reload は 0.9923→0.9885、speed は 1.0083→1.0120 の並びの途中)。
	{"id": "lord_gemini", "group": "lord", "name": "ジェミニ狩り", "desc": "ジェミニ を討伐", "check": "lord", "target": "gemini", "need": 1, "buff": {"reload": 0.9778}, "icon": "res://assets/images/pixel/lord_gemini.png"},
	{"id": "lord_reaper", "group": "lord", "name": "死神狩り", "desc": "死神 を討伐", "check": "lord", "target": "reaper", "need": 1, "buff": {"speed": 1.0220}, "icon": "res://assets/images/pixel/lord_reaper.png"},
	{"id": "lord_ghost", "group": "lord", "name": "幽霊船狩り", "desc": "幽霊船 を討伐", "check": "lord", "target": "ghost", "need": 1, "buff": {"reload": 0.9770}, "icon": "res://assets/images/pixel/lord_ghost.png"},
	{"id": "lord_leviathan", "group": "lord", "name": "レヴィアタン狩り", "desc": "レヴィアタン を討伐", "check": "lord", "target": "leviathan", "need": 1, "buff": {"speed": 1.0240}, "icon": "res://assets/images/pixel/lord_leviathan.png"},
	{"id": "charge_all", "group": "fleet", "name": "突撃!", "desc": "5隻すべてに超硬タングステン衝角を装備して「突撃」を発動", "check": "fleet", "target": "", "need": 0, "buff": {"ram": 1.0300}, "icon": "res://assets/images/pixel/badge_charge.png"},
	{"id": "weapon_master", "group": "fleet", "name": "ウェポンマスター", "desc": "全種類の武器を装備したことがある", "check": "fleet", "target": "", "need": 0, "buff": {"shot_dmg": 1.0280}, "icon": "res://assets/images/pixel/badge_weapon.png"},
	{"id": "mixed_fleet", "group": "fleet", "name": "混合船団", "desc": "駆逐艦・軽/重フリゲート・快速戦艦・巨大戦艦で船団を編成", "check": "fleet", "target": "", "need": 0, "buff": {"speed": 1.0260}, "icon": "res://assets/images/pixel/badge_mixed.png"},
	{"id": "battle_fleet", "group": "fleet", "name": "堂々たる戦艦部隊", "desc": "5隻すべてが快速戦艦か巨大戦艦", "check": "fleet", "target": "", "need": 0, "buff": {"fleet_dmg_taken": 0.9760}, "icon": "res://assets/images/pixel/badge_battle.png"},
	{"id": "master_one", "group": "crew", "name": "極めし者", "desc": "いずれかのパラメータがカンストしたクルーがいる", "check": "crew", "target": "", "need": 0, "buff": {"shot_speed": 1.0260}, "icon": "res://assets/images/pixel/badge_master1.png"},
	{"id": "master_all", "group": "crew", "name": "極めし者達", "desc": "カンストしたクルーが5隻すべてに乗っている", "check": "crew", "target": "", "need": 0, "buff": {"reload": 0.9600}, "icon": "res://assets/images/pixel/badge_master5.png"},
	{"id": "fame_max", "group": "wealth", "name": "名声赫赫", "desc": "名声999に到達", "check": "wealth", "target": "", "need": 0, "buff": {"shot_dmg": 1.0600}, "icon": "res://assets/images/pixel/badge_fame.png"},
	{"id": "rich", "group": "wealth", "name": "錦衣玉食", "desc": "資金1000000に到達", "check": "wealth", "target": "", "need": 0, "buff": {"flag_dmg_taken": 0.9600}, "icon": "res://assets/images/pixel/badge_rich.png"},
	{"id": "all_fish", "group": "fish", "name": "渭川漁父", "desc": "すべての種類の魚を漁獲", "check": "fish", "target": "", "need": 0, "buff": {"speed": 1.0120}, "icon": "res://assets/images/pixel/badge_fish.png"},
	{"id": "relic100", "group": "relic", "name": "考古学者", "desc": "旧文明の遺産を100個入手", "check": "relic", "target": "", "need": 100, "buff": {"reload": 0.9920}, "icon": "res://assets/images/pixel/badge_relic.png"},
	...
	{"id": "true_sea_ruler", "group": "other", "name": "真の海の王者", "desc": "ボスラッシュモードをクリア", "check": "boss_rush", "target": "", "need": 0,
		"buff": {"reload": 0.9700, "speed": 1.0300, "ram": 1.0300, "shot_dmg": 1.0400, "shot_speed": 1.0400, "flag_dmg_taken": 0.9600, "fleet_dmg_taken": 0.9700},
	...
	{"id": "ultimate_player", "group": "other", "name": "アルティメットプレーヤー", "desc": "他のすべての実績を達成", "check": "all", "target": "", "need": 0,
		"buff": {"reload": 0.9600, "speed": 1.0400, "ram": 1.0420, "shot_dmg": 1.0600, "shot_speed": 1.0460, "flag_dmg_taken": 0.9520, "fleet_dmg_taken": 0.9640},
...
# #263再2: 主は出現する島が決まっているので、その島でのHPを直接指定できるようにする。
#   5桁のHPは1000の倍数へ丸められるため、10500 のような値は基礎HPからは作れない。
#   hp_exact を持つ主は、自分の島にいる間だけこの値をそのまま使う。
#   別の海域(ボスラッシュは果ての島扱い)では従来どおり 基礎HP×海域倍率 で決まる。
func lord_hp(lid: String, island_idx: int) -> int:
	var d: Dictionary = lords.get(lid, {})
	if d.is_empty():
		return 0
	if d.has("hp_exact") and int(d.get("island", -1)) == island_idx:
		return int(d.hp_exact)
	return scaled_hp(float(d.get("hp", 0)), island_idx)
