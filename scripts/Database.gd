...
var combat_mobs := {
	...
	"dagon":         {"name": "ダゴン",         "hp": 1250, "dmg": 34, "cap": 9,  "price": 1280, "ranged": false, "aerial": false, "speed": 12.5, "reach": 2.5, "entangle": true, "poison": true, "size_mult": 0.85, "color": Color(0.3,0.5,0.35)},
	...
	"zahhak":        {"name": "ザッハーク",     "hp": 1480, "dmg": 30, "cap": 10, "price": 1560, "ranged": true, "aerial": true, "speed": 15.5, "atk_cd": 0.95, "range_mult": 1.3, "dodge": 0.15, "dodge_pass": true, "way": 3, "aim_tight": true, "shot_speed_mult": 0.8, "face_left": true, "color": Color(0.82,0.85,0.92)},
}
...
var lords := {
	...
	"dumbo":     {"name": "ウミダンボ",               "hp": 1000, "dmg": 18, "cap": 9,  "price": 1000, "bounty": 2000,  "fame": 10, "island": 0, "ranged": true, "aerial": false, "pair": false, "speed": 7.5, "way": 3, "dir": 135, "lore": "大きな耳で器用に泳ぐ。旧大陸が極度の海面上昇で沈没していく中、海に適応した象。"},
...
var pirates := {
	...
	# #179: 海賊船の元画像は左向き→face_leftで反転条件をそろえる(向きが逆だった件)
	"raider":   {"name": "海賊(小)", "hp": 220, "dmg": 11,  "bounty": 90,  "fame": 1, "ranged": true, "wpn": "gatling", "face_left": true, "color": Color(0.4,0.3,0.2)},
	"corsair":  {"name": "海賊(中)", "hp": 450, "dmg": 16, "bounty": 220, "fame": 2, "ranged": true, "volley": ["gatling", "cannon"], "face_left": true,  "color": Color(0.35,0.25,0.15)},
...
var ships := {
	...
	"cutter":   {"name": "外洋カッター",   "food": 160, "hold": 30,  "armor": 260,  "slots": 3, "range": 1, "speed": 12.0, "price": 9000,   "trade": 3500},
...
var islands := [
	...
	{"id": 3, "name": "果ての島",     "fame_req": 155,  "price_mult": 3.6, "pos": Vector3(2400, 0, -200), "spawn": ["octopus","bonito"], "lords": ["leviathan"]},
]
