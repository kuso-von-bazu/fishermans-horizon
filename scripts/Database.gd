...
var combat_mobs := {
	...
	"killer_shell":  {"name": "キラーシェル",   "hp": 1318, "dmg": 30, "cap": 7, "price": 1000, "ranged": true, "aerial": false, "speed": 0.0, "atk_cd": 1.35, "stationary": true, "range_mult": 1.6, "way": 2, "aim_tight": true, "shot_dmg_mult": 0.5, "reach": 1.6, "entangle": true, "no_attack": true, "counter_shot": 0.7, "color": Color(0.6,0.5,0.35)},
