...
var lords := {
	...
	"ghost":     {"name": "幽霊船",                   "hp": 8000, "dmg": 43, "cap": 20, "price": 7000, "bounty": 30000, "fame": 45, "island": 3, "ranged": true,  "aerial": false, "pair": false, "speed": 13.0, "atk_cd": 0.9, "volley_pool": ["gatling", "cannon", "torpedo"], "volley_pick": 2, "kite": true, "kite_hp": 0.667, "no_debuff": true, "no_escort": true, "dir": 225, "face_left": true, "color": Color(0.55,0.75,0.8), "lore": "レヴィアタンに轟沈させられた過去の勇士の魂が、いつしか幽霊船の形をとり辺りを彷徨うようになった。"},
