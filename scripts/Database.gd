...
var combat_mobs := {
	...
	"killer_shell":  {"name": "キラーシェル",   "hp": 1600, "dmg": 30, "cap": 7, "price": 1000, "ranged": true, "aerial": false, "speed": 0.0, "atk_cd": 1.35, "stationary": true, "range_mult": 1.6, "way": 2, "aim_tight": true, "shot_dmg_mult": 0.5, "reach": 1.6, "entangle": true, "no_attack": true, "counter_shot": 0.7, "color": Color(0.6,0.5,0.35)},
	"carabos":       {"name": "カーラボス",     "hp": 1150, "dmg": 27, "cap": 6, "price": 900, "ranged": true,  "aerial": false, "speed": 11.0, "atk_cd": 1.2, "reach": 2.2, "shoot_moving": true, "way_choices": [1,2], "color": Color(0.75,0.35,0.3)},
...
var weapons := {
	...
	"harpoon": {"name": "銛",             "kind": "aim",  "speed_mult": 0.6,  "dmg": 18, "cooldown": 1.0,  "reload": 1.8, "mag": 6,  "range": 100, "price": 900,  "slip": false, "debuff": true,  "homing": false, "sfx": "sfx_harpoon", "desc": "中威力。生物にデバフ付与"},
